...
replacements = {
    ...
    "net.minecraftforge.event.ForgeEventFactory": "net.neoforged.neoforge.event.EventHooks",  # 根据报告调整，可能为EventHooks
    ...
    "net.minecraftforge.network.Channel": "net.neoforged.neoforge.network.Channel",
    "net.minecraftforge.network.SimpleChannel": "net.neoforged.neoforge.network.SimpleChannel",
    "net.minecraftforge.network.PacketDistributor": "net.neoforged.neoforge.network.PacketDistributor",
    "net.minecraftforge.event.network.CustomPayloadEvent": "net.neoforged.neoforge.network.event.CustomPayloadEvent",
}
