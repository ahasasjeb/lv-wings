...
Starting from 2026, Mojang will discontinue the traditional 1.xx format (such as 1.20, 1.21) and adopt a new rule: year + update sequence number. Specifically:
Java Edition: The major version number will consist of two digits representing the year—for example, 26.1 indicates the first official update of 2026.