[Skip to main content](https://docs.neoforged.net/primer/docs/1.21.6/#__docusaurus_skipToContent_fallback)
...
#### Strata and Trees [​](https://docs.neoforged.net/primer/docs/1.21.6/\#strata-and-trees "Direct link to Strata and Trees")
...
### GuiElementRenderState [​](https://docs.neoforged.net/primer/docs/1.21.6/\#guielementrenderstate "Direct link to GuiElementRenderState")
...
### Custom Actions [​](https://docs.neoforged.net/primer/docs/1.21.6/\#custom-actions "Direct link to Custom Actions")
...
## Blaze3d Changes [​](https://docs.neoforged.net/primer/docs/1.21.6/\#blaze3d-changes "Direct link to Blaze3d Changes")
...
## Tag Providers: Appender Rewrite [​](https://docs.neoforged.net/primer/docs/1.21.6/\#tag-providers-appender-rewrite "Direct link to Tag Providers: Appender Rewrite")
...
### NBT Implementations [​](https://docs.neoforged.net/primer/docs/1.21.6/\#nbt-implementations "Direct link to NBT Implementations")
...
## Minor Migrations [​](https://docs.neoforged.net/primer/docs/1.21.6/\#minor-migrations "Direct link to Minor Migrations")

The following is a list of useful or interesting additions, changes, and removals that do not deserve their own section in the primer.

### Leashes [​](https://docs.neoforged.net/primer/docs/1.21.6/\#leashes "Direct link to Leashes")
...
### Removal of Mob Effects Atlas [​](https://docs.neoforged.net/primer/docs/1.21.6/\#removal-of-mob-effects-atlas "Direct link to Removal of Mob Effects Atlas")
...
### Permission Sources [​](https://docs.neoforged.net/primer/docs/1.21.6/\#permission-sources "Direct link to Permission Sources")
...
### Animation Baking [​](https://docs.neoforged.net/primer/docs/1.21.6/\#animation-baking "Direct link to Animation Baking")
...
### ChunkSectionLayers [​](https://docs.neoforged.net/primer/docs/1.21.6/\#chunksectionlayers "Direct link to ChunkSectionLayers")
...
### Tag Changes [​](https://docs.neoforged.net/primer/docs/1.21.6/\#tag-changes "Direct link to Tag Changes")
...
### List of Additions [​](https://docs.neoforged.net/primer/docs/1.21.6/\#list-of-additions "Direct link to List of Additions")
...
### List of Changes [​](https://docs.neoforged.net/primer/docs/1.21.6/\#list-of-changes "Direct link to List of Changes")
...
### List of Removals [​](https://docs.neoforged.net/primer/docs/1.21.6/\#list-of-removals "Direct link to List of Removals")
...
[![The NeoForged Project logo](https://neoforged.net/img/content/branding/banner.png)\\
\\
Files, News and information from the NeoForged Project](https://neoforged.net/ "The NeoForged project")

# NeoForge 21.6 for Minecraft 1.21.6

![NeoForged Team avatar](https://neoforged.net/img/authors/neoforged.png)NeoForged Team

June 17, 2025

[News](https://neoforged.net/categories/news/), [Releases](https://neoforged.net/categories/releases/)
...
[**`ValueInput`/ `ValueOutput`**](https://neoforged.net/news/21.6release/#valueinputvalueoutput)
...
[**GUI rendering changes**](https://neoforged.net/news/21.6release/#gui-rendering-changes)
...
[**Finding out what needs to be migrated**](https://neoforged.net/news/21.6release/#finding-out-what-needs-to-be-migrated)
...
[**Porting Primer**](https://neoforged.net/news/21.6release/#porting-primer)
...
![NeoForged Team avatar](https://neoforged.net/img/authors/neoforged.png)

About NeoForged Team

We are the NeoForged team.


[Github](https://github.com/NeoForged/ "Github")

[« Previous\\
2025 Serverside Summer](https://neoforged.net/news/2025serversidesummer/)

[Next »\\
2025 Serverside Summer Results](https://neoforged.net/news/2025serversidesummerresults/)

#### Recent Posts

- [The Transfer Rework](https://neoforged.net/news/21.9-transfer-rework/)
- [NeoForge 21.9 for Minecraft 1.21.9](https://neoforged.net/news/21.9release/)
- [2025 Serverside Summer Results](https://neoforged.net/news/2025serversidesummerresults/)
- [NeoForge 21.6 for Minecraft 1.21.6](https://neoforged.net/news/21.6release/)
- [2025 Serverside Summer](https://neoforged.net/news/2025serversidesummer/)

#### Categories

- [News](https://neoforged.net/categories/news/)
- [Personal Blog](https://neoforged.net/categories/personal-blog/)
- [Releases](https://neoforged.net/categories/releases/)

#### Links

[NeoForged Project Listing](https://projects.neoforged.net/ "NeoForged Project Listing")

[GitHub](https://github.com/neoforged/ "GitHub")

[Discord](https://discord.neoforged.net/ "Discord")

[Twitter](https://twitter.com/NeoForged_MC "Twitter")

[Open Collective](https://opencollective.com/neoforged "Open Collective")

[Current backend service status](https://status.neoforged.net/ "Current backend service status")

[Documentation](https://docs.neoforged.net/ "Documentation")

[Order a server from CreeperHost](https://www.creeperhost.net/partner/neoforge-aww "Order a server from CreeperHost")

[Team member application form](https://links.neoforged.net/apply "Team member application form")

[Discord ban appeal form](https://links.neoforged.net/appeal "Discord ban appeal form")

© 2025 The NeoForged project.
Generated with [Hugo](https://gohugo.io/) and [Mainroad](https://github.com/Vimux/Mainroad/) theme.
Customizations by [@lukebemish](https://github.com/lukebemish) and [@gigaherz](https://github.com/gigaherz)
