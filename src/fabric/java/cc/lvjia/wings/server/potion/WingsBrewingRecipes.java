...
public final class WingsBrewingRecipes {
    ...
    private static boolean isSlowFalling(ItemStack source) {
        ...
        PotionContents contents = source.getOrDefault(DataComponents.POTION_CONTENTS, PotionContents.EMPTY);
        return contents.is(Potions.SLOW_FALLING) || contents.is(Potions.LONG_SLOW_FALLING);
    }
