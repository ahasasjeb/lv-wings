...
public final class WingsBrewingCatalog {
    ...
    public static void forEachMix(BiConsumer<ItemLike, Supplier<? extends Item>> consumer) {
        ...
        consumer.accept(Items.DYE.red(), WingsItems.PARROT_WINGS_BOTTLE);
        consumer.accept(WingsItems.BAT_BLOOD_BOTTLE.get(), WingsItems.BAT_WINGS_BOTTLE);
        consumer.accept(Items.DYE.blue(), WingsItems.BLUE_BUTTERFLY_WINGS_BOTTLE);
        ...
        consumer.accept(Items.DYE.orange(), WingsItems.MONARCH_BUTTERFLY_WINGS_BOTTLE);
